...
const TeacherTeam = () => {
  const teamMembers = [
    ...
    },
    {
      ...
      bio: "Konya Ereğli Öğretmen Okulu mezunu fedakâr bir sınıf öğretmeninin (Sabri Bey) oğlu olarak Anadolu’nun Yazlıca köyünde dünyaya geldi. Çocukluk yılları elektriksiz köylerde, gaz lambalarının ışığında ve geleneksel köy oyunlarıyla geçti. İlkokulu Ilgın Merkez Cumhuriyet İlkokulunda tamamladı. Ilgın İmam Hatip Ortaokulunda başlayan öğrenimine, bir sınavla Isparta Merkez İmam Hatip Lisesi’nde parasız yatılı olarak devam etti. 1993 yılında Selçuk Üniversitesi İlahiyat Fakültesinden mezun oldu. “Rivayet İlimleri ve Tenkit Usulleri Açısından Ebu Musa el-Eş’ari Kökenli Hadisler” teziyle Yüksek Lisansını tamamladı ve Hadis Bilim Dalında Bilim Uzmanı unvanını aldı. Din Eğitimi alanında doktora çalışmalarını sürdürmektedir."
    },
    {
      name: "Dr. Fahri Güzel",
    ...
    {
        name: "Ramazan Kayan",
        title: "(Özgün İrade Dergisi Genel Yayın Yönetmeni)",
    ...
    },
    {
        ...
        title: "(Hacettepe Üniversitesi Eczacılık Fakültesi)",
    ...
    },
    {
        ...
        title: "(İstanbul Üniversitesi-Cerrahpaşa öÖğretim Üyesi)",
