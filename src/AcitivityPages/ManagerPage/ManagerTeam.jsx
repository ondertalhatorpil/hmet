...
const ManagerTeam = () => {
  const teamMembers = [
    ...
    },
    {
      ...
      bio: "İbn Haldun Üniversitesi Eğitim Fakültesi Eğitim Bilimleri Bölüm Başkanı Dr. Mehmet Akın Bulut, Boğaziçi Üniversitesi Eğitim Fakültesi'nde lisans eğitimini, Dil Öğretme ve Öğrenme ve Ölçme ve Değerlendirme'de ise yüksek lisans eğitimini tamamladı. Bahçeşehir Üniversitesi Eğitim Teknolojileri alanında Akademisyen Gelişim ve Dijital Yetkinlikler konusunda doktora derecesine sahiptir. 5 yıllık akademisyen eğitim merkezi (Yapay Zeka - Yenilikçi Öğrenme ve Öğretme Merkezi) kurucu direktörlüğü ve Dil Okulu'nda kurucu ve akademik koordinatörlük görevleri yürütmüştür. 'Yetişkin Eğitimi ve Hayat Boyu Öğrenme', 'Eğitim Teknolojileri' derslerini vermektedir. Bu alanlarda bilimsel yayınları vardır. Üniversite, K12 ve kurumsal düzeyde eğitimler yürütmektedir. Çeşitli Avrupa Birliği, John Templeton ve TÜBİTAK projelerinde koordinatör, araştırmacı ve eğitmen olarak yer almıştır. Yükseköğretimde Yapay Zeka başlıklı kitabı uluslararası bir yayınevinden çıkmıştır."
    },
    {
